...
UPDATE_CONFIGURATION_PATH = os.environ.get('UPDATE_CONFIGURATION_PATH', "/tmp/sigma_updater_config.yaml")
...
def sigma_update() -> None:
    ...
    try:
        ...
        if al_client.signature.update_available(since=previous_update or '', sig_type='sigma')['update_available']:
